var Roommate = /** @class */ (function () {
    function Roommate(name, password) {
        this.name = name;
...
var RoommateProfil = /** @class */ (function () {
    function RoommateProfil(name, address, city, area, animal, smoke, flor, rooms, partersNo, price, imgSrc) {
        this.name = name;
...
var ApartmentProfil = /** @class */ (function () {
    function ApartmentProfil(address, city, area, animal, smoke, flor, rooms, partersNo, price, imgSrc) {
        this.address = address;
        this.city = city;
        this.area = area;
        this.animal = animal;
